...
public class ModuleIOTalonFX implements ModuleIO {
    ...
    public ModuleIOTalonFX(int driveMotorId, int turningMotorId, InvertedValue driveMotorReversed,
        ...
        driveConfig.Slot0 = new Slot0Configs()
                ...
                .withKV(kV)
                .withKA(kA);
        driveConfig.Feedback.SensorToMechanismRatio = Constants.ModuleConstants.kDriveMotorGearRatio;
        // driveConfig.TorqueCurrent.PeakForwardTorqueCurrent = constants.SlipCurrent;
        // driveConfig.TorqueCurrent.PeakReverseTorqueCurrent = -constants.SlipCurrent;
        // driveConfig.CurrentLimits.StatorCurrentLimit = constants.SlipCurrent;
        // driveConfig.CurrentLimits.StatorCurrentLimitEnable = true;
        driveConfig.MotorOutput.Inverted = turningMotorReversed;
        ...
        turnConfig.Slot0 = new Slot0Configs()
                .withKP(ModuleConstants.kPTurning)
                .withKI(ModuleConstants.kITurning)
                .withKD(ModuleConstants.kDTurning);
        ...
        BaseStatusSignal.setUpdateFrequencyForAll(
                SwerveSubsystem.ODOMETRY_FREQUENCY, drivePosition, turnPosition);
        BaseStatusSignal.setUpdateFrequencyForAll(
                50.0,
                driveVelocity,
                driveAppliedVolts,
